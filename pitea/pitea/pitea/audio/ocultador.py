...
def ocultar_datos_en_audio(audio_entrada, imagen_entrada, audio_salida):
    ...
    ), "El archivo de audio debe ser de 16 bits"  # Asegurarse de que el archivo de audio sea de 16 bits
    ...
    with wave.open(
        audio_salida, "wb"
    ) as audio_modificado:  # Guardar los frames modificados en un nuevo archivo de audio
